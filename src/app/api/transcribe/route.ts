...
export async function POST(request: NextRequest) {
  try {
    ...
    const transcription = await openai.audio.transcriptions.create({
      ...
      prompt:"Umm, let me think like, hmm... Okay, here's what I'm, like, thinking. So, you are ah.. a speech coach, ummm, and you are basically helping the user to aaah....hmm, identify improvement opportunities for their ah...impromptu speech. ",// Or your preferred Whisper model
